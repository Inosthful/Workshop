...
const MissionTile = ({ mission, onClick }) => {
    return (
        <div className="max-w-sm bg-[color:var(--primary)] min-w-[300px]">
            ...
            <button className="flex items-center justify-between p-5 w-[100%] text-sm font-medium text-center text-[color:var(--on-primary)] bg-[color:var(--primary-shade)] transition-all hover:bg-[color:var(--background)] hover:text-[color:var(--on-background)]" onClick={onClick}>
                Voir la mission
