...
export const Landing = () => {
    return (
        <div className="bg-[color:var(--background)] pb-12">
            <h1 className="pb-6 pt-24 line leading-none w-[80vw] text-center m-auto text-zinc-300 text-[5vw] font-bold font-['Ubuntu']" data-aos="fade-up">Participer à la vie locale de votre quartier 👋</h1>
            <h3 className="pb-8 text-center m-auto text-zinc-300 text-xl font-normal font-['Amaranth']" data-aos="fade-up">Donner un coup de main  a vos commerçant/association</h3>
