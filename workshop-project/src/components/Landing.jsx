export const Landing = () => {
    return (
        <div className="bg-[color:var(--background)] pb-12">
            ...
            <div className="pb-32 text-center m-auto text-zinc-300 text-xl font-normal font-['Amaranth']" data-aos="fade-up">Donner un coup de main  a vos commerçant/association</div>
            <img className="m-auto w-[80vw] h-[625px] rounded-[10px] shadow border-4 border-neutral-200 object-cover" src="https://images.unsplash.com/photo-1593113598332-cd288d649433?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1770&q=80" data-aos="fade-up"/>
