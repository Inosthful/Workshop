    ...
    return (
        <div className="bg-[color:var(--background)]">
            ...
            <div className="flex justify-center flex-col items-center  rounded-xl ">
                ...
                <div className="w-[430px] md:w-[480px] h-[500px] px-[5px] py-5 bg-white rounded-[10px] shadow justify-start items-start gap-2.5 inline-flex mb-20">
                        <div className="flex-col justify-start items-start gap-5 inline-flex">
                            <div className="flex-col text-center gap-[61px] flex">
                                <div className="flex-col gap-[25px] flex">
                                    ...
                                    <div className='flex flex-col text-right justify-end items-end pr-5 pt-5'>
