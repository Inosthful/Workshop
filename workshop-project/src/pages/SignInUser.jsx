                            ...
                            <div className="flex-col text-center gap-[61px] flex">
                                <div className="flex-col gap-[25px] flex">
                                    ...
                                    <div className='flex flex-col text-right justify-end items-end pr-5 pt-20'>
                                        ...
                                        <NavLink to="/login/register/user" className={(navData) => (navData.isActive ? "underline bold text-yellow-400" : 'none')}><div className=" pt-5 items-start text-gray-500 underline">Vous avez deja un compte ? Connectez vous ici !</div></NavLink>
